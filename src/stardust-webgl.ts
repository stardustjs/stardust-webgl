...
Platform.Register("webgl-2d", (canvas: HTMLCanvasElement, width: number = 600, height: number = 400) => {
    return new WebGLCanvasPlatform2D(canvas, width, height);
});

Platform.Register("webgl-3d", (canvas: HTMLCanvasElement, width: number = 600, height: number = 400) => {
    return new WebGLCanvasPlatform3D(canvas, width, height);
});

Platform.Register("webgl-webvr", (canvas: HTMLCanvasElement, width: number = 600, height: number = 400) => {
